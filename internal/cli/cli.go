	...
	return capabilitiesReport{
		...
		Commands: []commandCapability{
			...
			},
			{
				...
				Category:       "macos",
				Summary:        "Install and start the lightweight macOS menu bar companion.",
				Stable:         true,
				RequiresRoot:   false,
				ChangesSystem:  false,
				ChangesNetwork: false,
			...
			},
			{
				...
				Category:       "macos",
				Summary:        "Inspect the macOS menu bar companion install and launch state.",
				Stable:         true,
				RequiresRoot:   false,
				ChangesSystem:  false,
				ChangesNetwork: false,
			...
			},
			{
				...
				Category:       "macos",
				Summary:        "Restart the macOS menu bar companion LaunchAgent.",
				Stable:         true,
				RequiresRoot:   false,
				ChangesSystem:  false,
				ChangesNetwork: false,
			...
			},
			{
				...
				Category:       "macos",
				Summary:        "Remove the macOS menu bar companion and its user LaunchAgent.",
				Stable:         true,
				RequiresRoot:   false,
				ChangesSystem:  false,
				ChangesNetwork: false,
