...
- 平台:**linux/amd64 + linux/arm64**(开箱即用)+ **macOS 真机已跑通**;**Windows 移植代码完整**(OpenTUN/DirectDialer/Hijack/WFP/Service 全落地,交叉编译 amd64/arm64 过,**真机待验**)。
